...
<html lang="en">
  <head>
    ...
    })(window,document,'script','dataLayer','GTM-TV48SWW');</script>
...
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-PVRTK8S');</script>
<!-- End Google Tag Manager -->
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="css/personalice.css">
    <link rel="stylesheet" href="css/owl.carousel.min.css">
    <title>TARGETSOFTDECOLOMBIA SAS</title>
  </head>
  <body>
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="header-3">
      <nav class="navbar navbar-expand-lg  fixed-top" style="background-color: rgba(0, 0, 0, 0.1);">
        <div class="container">
          <a class="navbar-brand mb-0" href="#"><img src="css/img/logo.png" width="150" height="30"/></a>
      ...
      <div class="page-carousel" id="home" style="">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="8000">
          ...
          <div class="carousel-inner" role="listbox" style="max-width: 100%;">
            <div class="carousel-item active">
              <div class="page-header" style="background-image: url('css/img/micro16.png') ; background-position:-30em;  background-size:cover; background-repeat: no-repeat;background-color:#f9f9f9;">
                <div class="content-center">
                  <div class="container">
                    <div class="row">
                      <div class="col-sm-8 text-center" style=" max-width: 90%; margin:0 auto" >
                        <img src="css/img/logo-q.png" style="max-width: 60%; ">
                        <h1> Software para Laboratorios Patológicos y Citológicos</h1>
                        <h5 style=" max-width: 90%; margin:0 auto" ><span style="font-weight: bold; color:#9f0203 ">Software Administrativo</span> en diagnóstico de cáncer y seguimiento a  resultados de pacientes en fase precancerosa o in situ.</h5>
...
<section id="sec-center" class="gray">
	<div class="container">
		<div class="row">
...
$desti="info@targetsoftdecolombia.com";
  
		
		
	$mensaje .="Prospecto Landing Covid
	---------------------------------------------------
...
$headers .= "From: Targetsoft: Landing page <web@targetsoftdecolombia.com>\r\n" . 
			"Bcc: \r\n";

	
	mail($desti,"Prospecto Landing: Targetsoft", $mensaje, $headers );
echo (' <section>
...
<br><br>
          <h2 class="main-title text-center text-dark font-weight-bold">¡Gracias!</h2>
          <br>
          <p class="text-dark " style="font-size: 1rem">Nos pondremos en contacto a la brevedad
</p>
...
<div class="container align-self-center">
      ...
      <div class="row">
        ...
        <div class="col-12 pt-2 pb-2">
<br><br>
          <h2 class="main-title text-center text-dark font-weight-bold">¡Ups!</h2>
          <br>
          <p class="text-dark " style="font-size: 1rem">Algo salió mal, Porfavor vuelve a enviar el formulario. <a href="index.php">Atras.</a>
</p>
